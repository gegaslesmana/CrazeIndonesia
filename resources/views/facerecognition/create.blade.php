<style>
    ...
    /* ============================================
       STATUS INDICATORS (Clean & Modern)
       ============================================ */
    .status-indicator {
        position: absolute;
        top: 30px;
    ...
    /* ============================================
       MODAL STYLING (Additional - untuk memastikan)
       ============================================ */
    #modal .modal-body {
        padding: 0 !important;
        background: #000;
...
<!-- Fullscreen Professional Face Recognition Interface -->
    ...
    <div class="progress-container" id="progressContainer">
        <div class="progress-text" id="progressText">Menunggu posisi wajah...</div>
    ...
    <div class="info-panel" id="infoPanel">
        <div class="info-item">
            ...
            <span class="resolution-info">Loading...</span>
        </div>
        <div class="info-item">
            <i class="ti ti-photo"></i>
            <span>Kualitas: 95%</span>
        </div>
        <div class="info-item aspect-ratio-info">
    ...
    <div class="guide-text" id="guideText">
        Posisikan wajah Anda di dalam kotak panduan hijau
    </div>

    <!-- Start Button -->
    <button id="btnMulaiRekam" class="btn btn-success btn-lg btn-start-overlay">
